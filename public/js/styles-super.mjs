import { LitElement, css } from 'https://cdn.pika.dev/-/lit-element/2.2.1/dist-es2019/lit-element.min.js';
...
export class stylesSuper extends LitElement {
	static get styles() {
		...
		h1,h2,h3,h4,h5,h6{font-family:'Roboto',sans-serif;font-weight:bold;margin:0px 0}.wide{letter-spacing:4px}
		...
		sub{bottom:-0.25em}sup{top:-0.5em}figure{margin:1em 40px}img{border-style:none;margin:0}
